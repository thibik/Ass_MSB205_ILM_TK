...
Artikkelen Bishop et al. (2020) tar for seg bruken av hedoniske modeller for å videre måle betalingsvilligheten for miljøkvalitet i et boligmarket, nærmere bestemt "marginal willingness to pay (MWTP)". Modellen tar utgangspunkt i at boligkjøpere velger bolig basert på to ulike faktorer; "stedsspesifikke fasiliteter" som innebærer blant annet luftkvalitet, utdanning o.l og "boligattributter" som for eksempel antall soverom og bad.

### Rosen sitt første og andre steg

Rosen (1974) sitt første steg innebærer å definere det gitte markedet for å videre kunne tilfredstille prinsippet om "law of one price function". Dette innebærer at i et marked, vil hus som er identiske selges for samme pris. Betingelsene i prinsippet kan variere over tid ettersom flyttekostander, informasjon og institusjoner kan endres. Selve markedet kan defineres på ulike måter, hvor den vanligste definisjonen er å se markedet som helhet, som et storbyområde over tid. Alternativt kan markedet defineres ved å se på data over tid, og over et større område enn kun ett. Det er likevel viktig å tilfredstille "law of one price function", hvor alternativ én dermed fungerer bedre i definisjonen av et marked. Ved å velge alternativ én vil en unngå å eksempelvis måtte hensynta flyttekostnader, jobbendring, skattekostnader og levekostnader som følge av flytting på tvers av metropoler.

Videre, etter markedet er klart definert starter innsamlingen av data - Rosen sitt andre steg. Det mest ønskelige for innsamling av data er å oppnå vilkårlig utvalg. De hedoniske boligverdi-studiene som nettopp oppnår den ønskelige data-innsamlingen, har oftest et fokus på eneboliger. I noen land, eksempelvis Norge og USA, blir kjøp og salg av bolig tinglyst noe som gjør boligtransaksjoner tilgjengelig for offentligheten. Dette betyr også tilgjengelighet for forskere, hvor en lettere kan få oversikt over eneboligsalg og også vurdere salgene i gitte tidsrom. Det er nærliggende å tro at den innsamlede og tilgjengelige dataen inneholder inntastningsfeil. Det er dermed viktig å luke ut og identifisere de potensielle feilene, for å oppnå best mulig kvalitet på data samt redusere feil. De feilene som oftest oppstår er ekskludering av data når kjøper og selger har likt etternavn, hvor slektskap kan være sannsynlig. Videre blir data for boliger kjøpt av investerings- og eiendomsfirma og tvangssalg utelatt, ettersom det kan forekomme at kvalitetsdetaljer og utfordringer ved boligen ikke er inkludert som en del av salgsrapporten. Det er også nødvendig å ekskludere data-avvik som eksempelvis at en bolig har flere hundre soverom.

### MWTP og boligmarkedet som ett meteropolområde

Forskere som benytter den hedoniske modellen må redegjøre for kjøpernes tanker rundt de tilgjengelige fasiliterer i det gitte boligområdet til huset. Dette innebærer videre å etablere en modell som evner å måle den romlige variasjonen av fasilitetene. Denne modellen kan skape hodebry for forskerne fordi dataen kan være varierende og ujevne, som videre kan gjøre det noe utfordrende å jobbe med. Dermed må forskerne evne å plukke ut hvilke målinger som best reflekterer det som ønskes svar på, dette må også være klart definert.

Det er ikke alltid salgspriser og data knyttet til eneboliger er tilgjengelig, men det finnes alternativer hvor forskerne gjerne heller benytter data for leiepriser, "anslåtte priser" (predicted), romlige aggregerte data og tomtesalg. Selv om det finnes alternativer, fører alternativene likevel med seg en del utfordirnger. Det å bruke data for leiepriser er i utgangspunktet et godt alternativ til eneboliger - men betingelsene i leiekontrakten kan være vanskelig å måle, hvor eksempelvis det ikke er intuitivt om utleier eller leietaker eksempelvis betaler for vedlikehold. Det kan også være utfordende å vurdere om kortitds-leietakere har samme behov og preferanser som eneboligkjøpere med tanke på område-fasilitene.

Data knyttet til anslåtte priser kan ofte være påvirket av selgers egne antakelser knyttet til boligverdien - en estimering som gjerne er gjort gjennom spørreundersøkelser. Anslått pris kan også bli satt av utenforstående eiendomsfirma/megler, men det er likevel foretrukket å benytte boligens faktiske prisverdi og ikke en anslått verdi. Utfordringen de anslåtte prisene omhandler er målefeil knyttet opp mot fasiliteter (bolig, nabolag, demografi), som kan føre til en skjevhet i prisestimatet.

Den hedoniske modellen kan som nevnt også benytte tomtesalg som et alternativ til eneboligsalg. Tomtesalg kan si noe om prisvariasjonen opp mot karakteristikken av området. Problemet med tomtesalg er at det er noen faktorer som her også kan skape skjevfordeling i prisestimatet, fordi det ikke er observasjonsgrunnlag. Dette innebærer blant annet vanntilførsel og kloakk, samt bestemte lover for området og inndeling av soner.

Sist, kan romlige aggregerte data benyttes - men her er det utfordringer knyttet til median ettersom at medianprisene kan avvike fra det generelle prisnivået. Dette gjør at hedoniske prisregresjoner som inkluderer medianer vil være skjeve ved starten av målingen - som videre kan ha utslag på MWTP.

Det er viktig å unngå de utelatte variablene når den hedoniske prismodellen skal estimeres på bakgrunn av to variabler. Den første går ut på at det vil være usannsynlig at forskere kan inkludere alle preferanser kjøpere har knyttet til fasiliteter. Det andre er den skjevfordelingen som oppstår når noen av kjøperne sine preferanser ikke er inkludert eller i modellen. Bishop et. al (2020) knytter følgende eksempel til de utelatte variablene; Dersom boligkjøpere fra "overklassen" velger å flytte til et annet område med begrunnelsen om at det nye området har bedre luftkvalitet, for og så stemme for et økt tilskudd til offentlige skoler, vil det være en skjevhet i den estimerte MWTP for luftkvalitet dersom skolen er en utelatt faktor i modellen.
