...
kc_tracts10_shore_env_data <- left_join(
  kc_tracts10_shore,  kc_wadho_map_2,
  by = "GEO_ID_TRT"
)
```
...
# st_write(kc_tracts10_shore_env_var, "../cenusSHP/kc_tracts10_shore_env_var.gpkg", append=FALSE)
```

## Har fått de siste filene fra Kine.
